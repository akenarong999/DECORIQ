...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
      ...
      <nav id="store-navbar" class="navbar navbar-expand-md navbar-light py-2 bg-white">
         <div class="container">
              <div class="navbar-header">
               <a href="/seller" class="navbar-brand text-primary pt-3">
                <img class="rounded-circle mr-2 d-inline" width="45" src="https://www.wazzadu.com/uploads/profile/7c721870-efb5-11e6-8518-29e6331eefc0.png"> Seller Center</a>
