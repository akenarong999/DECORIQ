...
@section('content')
  <section id="seller-dashboard-add-product-page">
     <div class="container bg-white border mt-3 p-5 mb-3">
       ...
       {!! Form::model($service,['method'=>'PATCH',  'action'=>array('StoreManager\ServicesController@update',$store->username,$service->id),'files'=>true,'id'=>'edit-service-form']) !!}
        ...
        <div class="form-group mb-5">
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                {!! Form::select('service_category_id', $all_categories, null, ['class'=>'form-control','id'=>'subcategories']) !!}
