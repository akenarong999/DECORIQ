...
<?php use \App\Http\Controllers\StoreManager\ProductsController; ?>
  ...
  <section id="seller-dashboard-add-product-page">
     <div class="container bg-white border mt-3 p-5 mb-3">
       ...
       {!! Form::model($product,['method'=>'PATCH', 'action'=>['Admin\AdminProductsController@update',$product->id],'files'=>true,'id'=>'editproductform']) !!}
       ...
       <div class="form-group mb-4 mt-4">
        ...
        <div class="form-group mb-5">
            <div class="row">
              ...
              <div class="col-sm-4">
                <label for="SKU">รหัสสินค้าของร้าน</label>
                      ...
                      <?php if(count($product_variations)==NULL){ ?>
                        <?php $variable_array_count = 1;  ?>
                          <div class="row mb-2 mt-3 variation-row border-bottom">
                            <div class="col-sm-2">
                              <label for="product"><label><input type="file" onchange="readURL(this,1);" style="display:none" name="file[]" /><img id="image-preview-1" src="http://placehold.it/180" class="img-fluid" src="" alt="your image" /></label></label>
                            </div>
                            <div class="col-sm-3">
                         ...
                         @foreach($product_variations as $product_variation)
                           <div class="row mb-2 mt-3 variation-row border-bottom">
                             ...
                             <div class="col-sm-2">
                                 ...
                                 <label for="product"><label><input type="file" onchange="readURL(this,<?php echo $j ?>);" style="display:none" name="file[]" /><img id="image-preview-<?php echo $j ?>" class="img-fluid" src="<?php  if(empty($product_variation_photo)){ echo 'http://placehold.it/180';} else { echo '/images/'.$product_variation_photo;} ?>" alt="your image" /></label></label>
                             </div>
                             <div class="col-sm-3">
                                 <label>รูปแบบที่ #<?php echo $j ?></label><input type="text" name="variationname[]" class="form-control" placeholder="" value="{{$product_variation->name}}">
                             </div>
                             <div class="col-sm-2">
                                 <label>ราคา</label><input type="text" name="variationprice[]" value="{{$product_variation->price}}" class="form-control">
                             </div>
                             <div class="col-sm-2">
                                 <label>น้ำหนัก(kg)</label><input name="variationweight[]" type="text" class="form-control" value="{{$product_variation->weight}}">
                             </div>
                             <div class="col-sm-2">
                                 <label>จำนวนในสต็อก</label><input name="variationstock[]" type="text" class="form-control" value="{{$product_variation->stock}}">
                             </div>
