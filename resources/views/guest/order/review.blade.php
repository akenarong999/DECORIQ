        ...
        <?php $products = $order->products; ?>
         ...
         <div class="row border-bottom pt-4">
            ...
            <div class="col-10">
              ...
              เขียนความคิดเห็น: <br>
              <textarea class="form-control" name="review-message-<?php echo $product->product_id ?>" placeholder="เขียนความคิดเห็นของคุณที่นี่" required></textarea>
              <input type="file" class="review-photos" name="review-photo-<?php echo $product->product_id ?>" class="mb-5" >
              </div>
            </div>
          ...
          <?php } ?>
                ...
                <div class="row">
                  <div class="col-12 pt-3">
                    <button type="submit" class="btn btn-lg btn-primary col-12" name="button">ส่งรีวิว</button>
                  </div>
                </div>
              </form>
